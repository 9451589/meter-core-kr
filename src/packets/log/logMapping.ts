...
>([
  ...
  [
    logId.InstanceZoneEnteredNotify,
    [names.InstanceZoneEnteredNotify, reads.InstaceZoneEnteredNotify, writes.InstanceZoneEnteredNotify],
  ],
  [logId.SkillCooldownNotify, [names.SkillCooldownNotify, reads.SkillCooldownNotify, writes.SkillCooldownNotify]],
  [logId.PCInspectResult, [names.PCInspectResult, reads.PCInspectResult, writes.PCInspectResult]],
