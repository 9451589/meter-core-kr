...
export type Struct_673 = {
  ...
  struct_236: Buffer;
  unk4: number;
  struct_23: { struct_235: Buffer; unk1_0_1: number; unk1_0_2: number }[];
};
export function read(reader: Read) {
  ...
  data.struct_23 = reader.array(
    reader.u16(),
    () => {
      const q = {} as { struct_235: Buffer; unk1_0_1: number; unk1_0_2: number };
      q.struct_235 = reader.bytes(reader.u16(), 2, 2);
